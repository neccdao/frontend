...
export default function PositionEditor(props) {
  const { positionsMap, positionKey, isVisible, setIsVisible, infoTokens, active, account, library, collateralTokenAddress, pendingTxns, setPendingTxns, getLiquidationPrice, getUsd, getLeverage } = props
  ...
  const getError = () => {
    ...
    if (nextLeverage && nextLeverage.eq(0)) { return "Enter amount" }
