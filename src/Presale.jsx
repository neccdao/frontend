...
export default function Presale() {
  ...
  if (busdQty !== "0") {
    gmtAmount = ethers.BigNumber.from(busdQty).mul(PRECISION).div(4.5 * PRECISION).toString()
  }
  ...
  }, [active, library, updateBusdReceived,
      updateBusdBalance, updateGmtBalance, updateBusdSent,
      updateInWhitelist, updateBusdAllowance])
  ...
  return(
    <div className="Presale">
      ...
      <div className="Presale-subtitle">Worth of <strong>$GMT</strong> purchased</div>
        ...
        <div className="Presale-card">
          <div className="Presale-card-content">
            ...
            <div className="Card-content">
              <div className="Presale-account-label">
                Account
              </div>
              <div className="Presale-account">
                {account}
              </div>
            ...
            <div className="App-input Presale-send-input">
              ...
              <div className="App-input-container">
                <div className="App-input-holder">
                  <input type="text" placeholder="0" value={busdQtyInput}  onChange={(e) => updateBusdQtyInput(e.target.value) } disabled={true}/>
                </div>
                <div className="App-input-unit">
                 BUSD
                </div>
              </div>
            </div>
            <div className="Presale-receive">
              You will receive {formatAmount(gmtAmount)} GMT
            </div>
            <br/>
